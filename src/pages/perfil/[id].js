...
import { fetchDadosUtilizador, podeVerPerfil } from "@/frontend/services/utilizador";
        ...
        <div>
            {Object.keys(utilizador).length > 0 && (
                ...
                <div className=" min-h-screen md:max-w-96 h-full bg-fundo-principal flex flex-col">
                    ...
                    />
                    {(utilizador.privado && (utilizador._id !== userLogado._id)) ? podeVerPerfil(userLogado._id, utilizador.quemSegue, utilizador.seguidores) ?
                        ...
                        : <h3 className="text-main-white">Este perfil é privado!</h3>
                        : <div className=" ml-4 mr-4">
                            <h1 className=" mb-6 text-lg mt-10 font-semibold text-main-white">
                                Quero Assistir
                            </h1>
