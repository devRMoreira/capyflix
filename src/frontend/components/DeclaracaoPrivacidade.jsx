export default function DeclaracaoPrivacidade(){
    return (
      ...
      <h3 className="ml-10 text-sm font-normal mb-2 text-main-white">1. Recolha de Dados</h3>
      <p className="text-left text-xs leading-relaxed mb-3 text-main-white">
        A App recolhe apenas os dados pessoais que forneces voluntariamente, tais como o nome e endereço de email.
      </p>
      <h3 className="ml-10 text-sm font-normal mb-2 text-main-white">2. Utilização de Dados</h3>
      <p className="text-left text-xs leading-relaxed mb-3 text-main-white">
      ...
      <h3 className="ml-10 text-sm font-normal mb-2 text-main-white">3. Partilha de Dados</h3>
      <p className="text-left text-xs leading-relaxed mb-3 text-main-white">
        Os teus dados pessoais não serão partilhados com terceiros sem consentimento.
      </p>
      <h3 className="ml-10 text-sm font-normal mb-2 text-main-white">4. Segurança de Dados</h3>
      <p className="text-left text-xs leading-relaxed mb-3 text-main-white">
      ...
      <h3 className="ml-10 text-sm font-normal mb-2 text-main-white">5. Direitos do Utilizador</h3>
      <p className="text-left text-xs leading-relaxed mb-3 text-main-white">
        Tens o direito de aceder, corrigir e eliminar os teus dados pessoais.
      </p>
      <h3 className="ml-10 text-sm font-normal mb-2 text-main-white">6. Contactos</h3>
      <p className="text-left text-xs leading-relaxed mb-3 text-main-white">
